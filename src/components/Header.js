...
import Select from './common/formTags';
  ...
  <div>
    <section className="mb-10">
      ...
      <div
        ...
        style={{ backgroundPosition: '50%', backgroundImage: 'url(\'https://mdbootstrap.com/img/new/textures/full/142.jpg\')', height: '300px' }}
      />
      ...
      <div className="container mx-auto px-6 md:px-12 xl:px-32">
        <div className="text-center text-gray-800">
          <div
            ...
            style={{ marginTop: '-170px', background: 'hsla(0, 0%, 100%, 0.7)', backdropFilter: 'blur(30px)' }}
          >
            ...
            <div>
              <div className="flex justify-center">
                <input type="type" placeholder="Search for Jobs" className="px-2 rounded-md" />
                <Select />
              </div>
              <div className="w-full mt-4">
                <button type="button" className="bg-blue-600 text-white rounded-md mx-2 px-4 py-2">Search</button>
              </div>
